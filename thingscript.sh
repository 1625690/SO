...
echo ${PORCMEM}
echo ${PORCHD}
curl --silent --request POST --header "X-THINGSPEAKAPIKEY:G545PDOQ13YAZF4W" --data "field1="${NUMPROCESOS}"&field2="${PORCMEM}"&field3="${HDPORC} http://api.thingspeak.com/update
